...
const ModalSample = (props) => {
    ...
    const fetchForms = () => {
        axios
            .get(`${url}forms`)
            .then((response) => {
                const formListSelect = response.data.map((x) => ({...x, label:x.name, value:x.code}));
                        ...
                        <Card >
                            <CardBody>
                                ...
                                <Row>
                                    <Col md={12}>
                                        <Alert color={"info"}>
                                            Please note that forms selected in the <b>'applicable forms'</b> box below will <b>only be visible</b> when a household member encounter matches this flag's field value.
                                        </Alert>
                                    </Col>
                                <Col md={6}>
                                    <FormGroup>
...
export default connect(null, { })(ModalSample);
